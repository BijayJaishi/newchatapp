...
class ChatScreenState extends State<ChatScreen> with WidgetsBindingObserver{
  ...
  void didChangeAppLifecycleState(AppLifecycleState state) {
    ...
    if(_notification==AppLifecycleState.paused || _notification == AppLifecycleState.inactive){
              ...
              children: <Widget>[
                document['type'] == 0
                    ...
                    ? Container(
                        ...
                        margin: EdgeInsets.only(bottom: /*isLastMessageRight(index) ? 20.0 : 10.0,*/0, right: 10.0),
                      )
                    : document['type'] == 1
                        // Image
                        ? Container(
